...
module.exports = (app, upload) => {
    //app.get('/api/categories/getAll', UsersControllers.getAll);

    app.post('/api/categories/create', passport.authenticate('jwt', {session : false}), CategoriesControllers.create);
